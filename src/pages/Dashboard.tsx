...
import { macroPresets } from "@/lib/macroCalculator";
...
const timeline = [
  ...
  {
    type: "meal",
    title: "Logged Breakfast \u2014 420 kcal",
    time: "Today, 8:15 AM",
    color: "#8B5CF6",
    Icon: Utensils,
  },
...
const notifications = [
  {
    type: "streak",
    message: "12-day workout streak! Keep it going!",
    active: true,
    time: "2 min ago",
  },
  {
    type: "coach",
    message: "Coach Maria commented on your leg day log",
    active: true,
    time: "1 hr ago",
  },
  {
    type: "goal",
    message: "You're 83% to your monthly steps goal",
    active: false,
    time: "3 hrs ago",
  },
];
...
const mockWeightData = [
  ...
  { date: "2023-01-08", weight: 83 },
  { date: "2023-01-15", weight: 81 },
  { date: "2023-01-22", weight: 79 },
  { date: "2023-01-29", weight: 77 },
  { date: "2023-02-05", weight: 76 },
  { date: "2023-02-12", weight: 75 },
  { date: "2023-02-19", weight: 74 },
  { date: "2023-02-26", weight: 73 },
  { date: "2023-03-05", weight: 72 },
  { date: "2023-03-12", weight: 71 },
  { date: "2023-03-19", weight: 70 },
  { date: "2023-03-26", weight: 69 },
  { date: "2023-04-02", weight: 68 },
  { date: "2023-04-09", weight: 67 },
  { date: "2023-04-16", weight: 66 },
  { date: "2023-04-23", weight: 65 },
  { date: "2023-04-30", weight: 64 },
  { date: "2023-05-07", weight: 63 },
  { date: "2023-05-14", weight: 62 },
];
...
export default function Dashboard() {
  // State for macro preset buttons
  const [selectedPreset, setSelectedPreset] = useState(macroPresets[0]);

  // Helper to convert preset to chart data
  const getMacroData = (preset: {
    protein: number;
    fats: number;
    carbs: number;
  }) => [
    { name: "Protein", value: preset.protein, color: "#0D9488" },
    { name: "Fats", value: preset.fats, color: "#06B6D4" },
    { name: "Carbs", value: preset.carbs, color: "#8B5CF6" },
  ];

  const currentMacroData = getMacroData(selectedPreset);
      ...
      {mode === "sheets" ? (
        ...
        <div className="mx-auto max-w-[1200px] px-4 pt-4 pb-20 lg:px-6 lg:pb-8">
          ...
          <div className="mt-8">
            ...
            <WeightTrendChart data={mockWeightData} />
          </div>
          <div className="mt-8">
            ...
            <div className="flex gap-2 mb-4">
              {macroPresets.map((preset) => (
                ...
                >
                  {preset.name} ({preset.protein}/{preset.fats}/{preset.carbs})
                </button>
              ))}
            </div>
            <MacroDistributionPieChart data={currentMacroData} />
          </div>
          ...
          >
            ...
            <div className="flex flex-col gap-2">
              {notifications.map((notif, i) => {
                ...
                const config =
                  iconConfig[notif.type as keyof typeof iconConfig] ||
                  iconConfig.goal;
                return (
                  <motion.div
                    key={i}
                  ...
                  >
                    ...
                    <PulsingDot
                      color={
                        notif.active ? "var(--success)" : "var(--light-border)"
                      }
                    />
